...
export const boardColumns = [
  {
    title: "Intake",
    count: 4,
    accent: "from-[#f3cf77] via-[#d9a441] to-[#b61f2c]",
    items: [
      {
  ...
  },
  {
    title: "In review",
    count: 5,
    accent: "from-[#f7e2a6] via-[#d9a441] to-[#8f1520]",
    items: [
      {
  ...
  },
  {
    title: "Scheduled",
    count: 6,
    accent: "from-[#e8b95d] via-[#c98a2d] to-[#a31a26]",
    items: [
      {
  ...
  },
  {
    title: "Completed",
    count: 9,
    accent: "from-[#fff0cb] via-[#e0b458] to-[#7a121b]",
    items: [
      {
